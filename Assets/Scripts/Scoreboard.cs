...
public class Scoreboard : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        sbBtnNextLevel = GameObject.Find("sbBtnNextLevel").GetComponent<Button>();
        sbBtnNextLevel.onClick.AddListener(sbButtonOnClick);
        Debug.Assert(sbBtnNextLevel.isActiveAndEnabled);
